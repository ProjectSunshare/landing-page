    ...
    <React.Fragment>
      {isLoading ? (
        ...
        <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="sectionIntro text-center text-white py-16 drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]" data-aos="fade-down" data-aos-delay="250" data-aos-duration="1000">
          ...
          <div className='rounded-2xl pt-3.5 drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] bg-white' data-aos="fade-up" data-aos-delay="250" data-aos-duration="1000">
            <div className="grid grid-cols-1">
              <div className='rounded-2xl pt-4 drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] bg-white'>
                              ...
                              >
                                {status.map((status) => (
                                  <Listbox.Option
                                    ...
                                    className={({ active }) =>
                                      classDate(
                                        active ? 'text-white bg-[#FEA803]' : 'text-gray-900',
                                    ...
                                    {({ selected, active }) => (
                                      <>
                                        <div className="flex items-center">
                                          <span
                                            className={classDate(selected ? 'font-semibold' : 'font-normal', 'ml-3 block truncate')}
                                          >
                                            {status.label}
                                          </span>
                                        </div>
                ...
                <div className='w-[95%] m-auto'>
                  <Chart options={chartData.options} series={series} type={chartData.type} height={chartData.height} />
                </div>
              </div>
            </div>
          </div>
