...
const Newsletter = () => {
	...
	return (
		<div className="py-36" data-aos="fade-down" data-aos-delay="250" data-aos-duration="1000">
			<form action="">
				<div className="newsletter-input mb-5">
					...
					/>
					<button
						className="inline ml-1 py-4 px-2 sm:px-5 md:px-10 bg-black border-2 border-black text-white sm:rounded-r-lg hover:bg-[#FEA803]"
						type="submit"
					>
