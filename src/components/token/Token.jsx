	...
	return (
		<div className="w-full h-full flex flex-col justify-between py-48">
			<div className="token-container grid md:grid-cols-2 max-w-[1920px] px-5 lg:px-30 xl:px-40 2xl:px-52">
				...
				{/* start token 3d */}
				<div className="w-full" data-aos="fade-right" data-aos-delay="250" data-aos-duration="1000">
					<img className="m-auto" src={token} alt="" />
				</div>
				{/* end token 3d */}

				{/* start token details */}
				<div className="token-details flex flex-col justify-center md:items-start w-full h-full" data-aos="fade-left" data-aos-delay="250" data-aos-duration="1000">
