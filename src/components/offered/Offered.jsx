	...
	return (
		<div className="w-full h-full flex flex-col justify-between">
			<div className="offer pt-20 px-5 lg:px-30 xl:px-40 md:text-start 2xl:px-52 2xl:pb-32">
				...
				{/* start title */}
				<div className="sectionIntro text-center py-16" data-aos="fade-down" data-aos-delay="250" data-aos-duration="1000">
				...
				<div className="marketplace grid md:grid-cols-2 md:grid max-w-[1920px] mb-20 md:mb-40">
					<div className="w-full mb-10 md:m-0" data-aos="fade-right" data-aos-delay="250" data-aos-duration="1000">
						<img className="m-auto" src={marketplace} alt="" />
					</div>
					<div className="flex flex-col justify-center md:items-start w-full h-full" data-aos="fade-left" data-aos-delay="250" data-aos-duration="1000">
				...
				<div className="analysis grid md:grid-cols-2 md:grid max-w-[1920px] mb-20 md:mb-40">
					<div className="flex flex-col justify-center md:items-start w-full h-full" data-aos="fade-right" data-aos-delay="250" data-aos-duration="1000">
					...
					<div className="w-full" data-aos="fade-left" data-aos-delay="250" data-aos-duration="1000">
